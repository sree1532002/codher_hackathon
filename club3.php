...
<html lang="en">
  <head>
    ...
    <title>Uniclub | Photography club</title>
  ...
  <div class="card mb-3" style="max-width: 100%;">
    <div class="row no-gutters">
      <div class="col-md-4">
        <img src="Images/photos.jpg" class="card-img" alt="...">
      </div>
      <div class="col-md-8">
        <div class="card-body">
          <h5 class="card-title">Welcome to the Photography Club!</h5>
          <p class="card-text">Is photography your passion? Do you see the world through a lens? Welcome, fellow artist!</p>
          <div class = "ideas">
          ...
          <div class="input-group mb-3">
            <form action = "addidea.php" method = "post" class = "ideatxt">
              ...
              <div class="input-group-append">
                  ...
                  <input type = "hidden" name = "clubno" value ="3">
              </div>
            </form>
          </div>
